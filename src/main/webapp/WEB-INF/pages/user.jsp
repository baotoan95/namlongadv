...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			<!-- Logo -->
			<a href="${pageContext.request.contextPath }/view" class="logo">
				<!-- mini logo for sidebar mini 50x50 pixels --> <span
				class="logo-mini"><b>NL</b></span> <!-- logo for regular state and mobile devices -->
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview active"><a href="#"> <i
						...
						<ul class="treeview-menu menu-open">
							...
							<li class="active"><a href="${pageContext.request.contextPath }/user"><i

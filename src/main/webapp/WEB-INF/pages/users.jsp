	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Data <small>list of users</small>
				</h1>
				<ol class="breadcrumb">
					...
					<div class="col-xs-12">
						<div class="box">
									...
									<tbody>
										...
										<tr>
											...
											<td class="action">
												...
												<br />
												<a href="${pageContext.request.contextPath }/user"><i class="fa fa-fw fa-edit"></i>Xem</a>
											</td>
										</tr>
										<tr>
											<td>abc1234</td>
							...
							<div class="box-footer clearfix">
								<a href="${pageContext.request.contextPath }/user" class="btn btn-info">Thêm mới</a>
